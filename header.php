    ...
    <div id="site-branding">
        ...
        <a href="<?php echo esc_url( home_url() ); ?>" rel="home">
					...
					if ( $flexi_display_header_logo === 'logo' ) {
						echo '<img class="headerlogoimage" src="' . esc_url( get_theme_mod( 'flexi_header_logo_image' ) ) . '" alt="logo">';
						echo '<h1 class="site-title" style="display: none;">' . esc_html( get_theme_mod( 'flexi_header_logo_text' ) ) . '</h1><span class="site-description" style="display:none">' . esc_html( get_theme_mod( 'blogdescription', get_bloginfo( 'description' ) ) ) . '</span>';
					} else {
				...
				<div id="cssmenu">
					...
					if ( !empty( $wp_customize ) && $wp_customize->is_preview() && !get_theme_mod( 'flexi_content_set', false ) ) {
						...
						<ul>
							...
							<li id="menu-item-17"
								class="menu-item">
								<a href="http://themefurnace.com/">More Free Themes</a></li>
							<li id="menu-item-21"
								class="menu-item">
								<a href="#">Blog</a></li>
							<li id="menu-item-22"
